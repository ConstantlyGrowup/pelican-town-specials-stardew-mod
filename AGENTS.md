...
2026-09-23 新增 Milestone 14：原料映射的数据归因、问题定位、本地 RAG 方案、JEV 评测、实现与同集对照，Task 61–66；计划见 `docs/plans/2026-09-23-milestone-14-ingredient-rag-evaluation.md` v1.4。Task66 冻结同集对照已完成并经独立 detector PASS：菜品全部合理率由旧 14/24 提升至显式 RAG 18/24，产品默认仍为 LEGACY；精确状态及未推送边界以 `STATUS.md` 为准。

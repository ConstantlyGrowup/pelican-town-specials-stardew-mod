...
2026-09-23 新增 Milestone 14：原料映射的数据归因、问题定位、本地 RAG 方案、JEV 评测、实现与同集对照，Task 61–66；计划见 `docs/plans/2026-09-23-milestone-14-ingredient-rag-evaluation.md` v1.4。用户已授权 Task 65，保持现实原料逐项召回；Task 66 以菜品全部合理率为主指标，精确状态以 `STATUS.md` 为准。
